            ...
            <div>
                ...
                <div className="grid md:grid-cols-3 mt-20">
                    <div className="flex justify-center items-center flex-col text-center gap-2">
                        ...
                        <p className="max-w-96 text-gray-500">Our restaurant is open from 11:00 AM to 9:00 PM, seven days a week. We're dedicated to providing our</p>
                    </div>
                    <div className="flex justify-center items-center flex-col text-center gap-2">
                    ...
                    <div className="flex justify-center items-center flex-col text-center gap-2">
                        ...
                        <p className="max-w-96 text-gray-500">If you're not completely satisfied with your dining experience, please let us know</p>
                    </div>
                </div>
            </div>
        </div>
