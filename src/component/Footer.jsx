...
const Footer = () => {
  return (
    <footer className="bg-gray-100 text-gray-700 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-gray-900 transition">Menu</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-gray-900 transition">Our Story</a></li>
              <li><a href="#" className="hover:text-gray-900 transition">Sustainability</a></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-sm text-center">
          <p>© 2025 CuisineArt, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
